...
export function BackToTop(props: Props) {
  ...
  return (
    <div
      ...
      className="fixed bottom-10 right-10 z-20 max-w-max p-[0.40rem] rounded-full bg-gray-700 text-gray-200 transition-all ease-in-out delay-150 duration-300 data-[visibilityBackToTop=false]:hidden flex flex-col items-center justify-center gap-4"
    >
