    ...
    <section id='abordagem' aria-labelledby='titulo-abordagem' className='approach-section'>
      <div className='mx-auto max-w-7xl'>
        <div className='grid gap-10 border-b border-border pb-14 md:grid-cols-3 md:gap-20'>
          <p className='text-sm font-medium text-primary'>{approach.label}</p>
          <h2 id='titulo-abordagem' className='font-heading text-4xl font-medium leading-tight tracking-tighter md:col-span-2 md:text-5xl'>{approach.title}</h2>
        </div>
