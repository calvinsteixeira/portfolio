    ...
    <section id='conhecimentos' aria-labelledby='titulo-conhecimentos' className='expertise-section'>
      <div className='mx-auto grid max-w-7xl gap-12 md:grid-cols-3 md:gap-20'>
        <div>
          ...
          <h2 id='titulo-conhecimentos' className='mt-5 max-w-sm font-heading text-4xl font-medium leading-tight tracking-tighter md:text-5xl'>{t('expertise.title')}</h2>
        </div>
        <div className='md:col-span-2'>
          <p className='max-w-xl text-lg leading-8 text-foreground/75'>{t('expertise.description')}</p>
